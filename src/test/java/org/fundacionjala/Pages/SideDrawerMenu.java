...
public class SideDrawerMenu extends PageObject {

    private final static String BOARDS_XPATH = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/" +
    ...
    public void openBoards(Home homePage){
